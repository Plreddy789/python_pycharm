# crop image using pillow module
from PIL import Image, ImageDraw, ImageFilter, ImageFont
img = Image.open('waterfall.jpg').convert("RGBA")

background = Image.new("RGBA", img.size, (0,0,0,0))

mask = Image.new("RGBA", img.size, 0)
draw = ImageDraw.Draw(mask)
draw.regular_polygon((600,600,700), 8, rotation=360, fill='green', outline=None)
...
# crop images using opencv2 and numpy
import cv2
import numpy as np
...
hexagon_points = np.array([
    (200, 400), (100, 300), (150, 200), (175,100),(300,10), ()
